...
src = partial(
    Option,
    '--historial', '--source', '--source-dir', '--source-directory',
    dest='src_dir',
    metavar='dir',
    default=src_prefix,
    help='Directory to check out editable projects into. '
    'The default in a virtualenv is "<venv path>/historial". '
    'The default for global installs is "<current dir>/historial".'
)
